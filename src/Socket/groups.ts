            ...
            const result = await groupQuery(groupJid, "set", [
                {
                    ...
                    attrs: {},
                    content: [
                        { tag: "participant", attrs: { jid: invitedJid } },
                    ],
                },
            ]);
            return !!result;
        ...
        groupAcceptInviteV4: ev.createBufferedFunction(
            async (
                    ...
                    [
                        {
                            ...
                            attrs: {
                                ...
                                expiration:
                                    inviteMessage.inviteExpiration!.toString(),
                                admin: key.remoteJid!,
                            },
                        },
                    ]
                ...
                if (key.id) {
                    ...
                    inviteMessage =
                        proto.Message.GroupInviteMessage.fromObject(
                            inviteMessage
                        );
...
export const extractGroupMetadata = (result: BinaryNode) => {
    ...
    const metadata: GroupMetadata = {
        ...
        owner: group.attrs.creator
            ? jidNormalizedUser(group.attrs.creator_pn ?? group.attrs.creator)
            : undefined,
        ...(group.attrs.creator_pn && {
            ...
            ({ attrs }) => {
                if (attrs.phone_number) {
                    return {
                        ...
                        lid: attrs.jid,
                        admin: (attrs.type ||
                            null) as GroupParticipant["admin"],
                    };
                } else {
                    return {
                        id: attrs.jid,
